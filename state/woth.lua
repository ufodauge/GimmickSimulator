...
function sandbox:enter()
  ...
  sequenceManager:add( Sequence:new( function()
    ...
    gimmickManager:add( FieldObject:new( { image = WOTH_DRAGON_IMAGE, x = dragon1_x, y = dragon1_y, drawPriority = 5, scale = 0.3 } ), 15.55 - 9.0 )
    gimmickManager:add( FieldObject:new( { image = WOTH_SOLIDER_IMAGE, x = solider1_x, y = solider1_y, drawPriority = 5, scale = 0.3 } ), 15.55 - 9.0 )
    gimmickManager:add( FieldObject:new( { image = WOTH_SOLIDER_IMAGE, x = solider2_x, y = solider2_y, drawPriority = 5, scale = 0.3 } ), 15.55 - 9.0 )
  end, 9.0 ) )
  ...
  sequenceManager:add( Sequence:new( function()
    ...
    local x, y = select( i, playerManager:getPlayers() ):getPosition()
    gimmickManager:add( CircleAoE:new( { x = x, y = y, r = 250, drawPriority = 5, prediction = 4.5 } ), 5 )
  end, 21.70 ) )
  ...
  sequenceManager:add( Sequence:new( function()
    ...
    local x, y = select( i, playerManager:getPlayers() ):getPosition()
    gimmickManager:add( CircleAoE:new( { x = x, y = y, r = 150, drawPriority = 5, prediction = 90 } ), 5 )
  end, 22.80 ) )
