...
DOTH_BLACK_DRAGON_IMAGE = love.graphics.newImage( 'resource/image/object/blackdragon.png', { mipmaps = true } )
DOTH_WHITE_DRAGON_IMAGE = love.graphics.newImage( 'resource/image/object/whitedragon.png', { mipmaps = true } )
...
DOTH_DEBUFF_DEATH_IMAGE = love.graphics.newImage( 'resource/image/object/debuff_death.png', { mipmaps = true } )
DOTH_CIRCLE_MARKER_IMAGE = love.graphics.newImage( 'resource/image/object/circmarker.png', { mipmaps = true } )
DOTH_CROSS_MARKER_IMAGE = love.graphics.newImage( 'resource/image/object/crossmarker.png', { mipmaps = true } )
DOTH_TRIANGLE_MARKER_IMAGE = love.graphics.newImage( 'resource/image/object/trimarker.png', { mipmaps = true } )
DOTH_SQUARE_MARKER_IMAGE = love.graphics.newImage( 'resource/image/object/sqmarker.png', { mipmaps = true } )
DOTH_DRAGON_EYE_IMAGE = love.graphics.newImage( 'resource/image/object/dragoneye.png', { mipmaps = true } )
...
DOTH_DRAGON_EYE_IMAGE:setFilter( 'nearest', 'nearest' )
